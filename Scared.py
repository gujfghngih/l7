...
{Fore.RED}                                                         ╩══════════════════════════════════════════╝
{Fore.RED}                                                         ╦═══════════════════════════════════════════╗
{Fore.RED}                                                         ║                    {Fore.YELLOW}INFO:                  {Fore.RED}║
{Fore.RED}                                                         ║                                           ║
{Fore.RED}                                                         ║  {Fore.LIGHTGREEN_EX}THIS IS A HIGH POWERED L7 BOTNET         {Fore.RED}║
{Fore.RED}                                                         ╩═══════════════════════════════════════════╝

{Fore.RED}                                                             ╦══════════════════════════════════════╗
{Fore.RED}                                                             ║  CREDITS: {Fore.YELLOW}Make By † Eternal Demon †  {Fore.RED}║
{Fore.RED}                                                             ╩══════════════════════════════════════╝
